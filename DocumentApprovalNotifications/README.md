...
├── PowerAutomate
│   └── document_approval_notifications_flow.json
├── Dataverse
│   └── schema.json
├── PowerApps
...
├── Python
│   └── send_approval_notification.py
├── PowerBI
│   └── document_approval_report.py
└── README.md


# Document Approval Notifications

This project automates document approval notifications using Microsoft Power Platform.
